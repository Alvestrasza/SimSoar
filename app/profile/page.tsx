      ...
      <div className="card" style={{ marginBottom: 20 }}>
        ...
        <form className="cardBody" action="/profile/save" method="post">
          <div className="formGrid">
            ...
            <div className="formGroup"><label>Callsign</label><input name="callsign" defaultValue={profile?.callsign ?? ""} required minLength={3} maxLength={32} pattern="[A-Za-z0-9_-]+" title="Nur Buchstaben, Zahlen, Unterstrich und Bindestrich. 3 bis 32 Zeichen." /></div>
